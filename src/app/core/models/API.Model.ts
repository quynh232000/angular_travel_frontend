...
export class FilterTourModel {
  ...
  constructor() {
    ...
    this.limit = 6;
    this.type = '';
    this.province_start_id = '';
    this.province_end_id = '';
    this.number_of_day = '';
    this.date_start = '';
    this.price = '0';
    this.tour_pakage = '';
...
export class OrderHis{
  ...
  constructor(){
    ...
    this.created_at = new Date()
    this.updated_at = new Date()
    this.order_detail= [new OrderHisDetail()]
  }
}
export class OrderHisDetail {
  id: number
  order_id: number
  product_id: number
  quantity: number
